...
Next, you can get an array with `toArray()` method, but `where()` method makes keys in the array discontinuous. You need to call `renum()` method to get the array of sequential keys.
